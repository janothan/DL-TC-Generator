...
public class GeneratorSyntheticConstructedHard extends GeneratorSynthetic {
    ...
    public GeneratorSyntheticConstructedHard(File directoryToGenerate) {
        ...
        generatorSet.add(new Tc09GeneratorSyntheticConstructedHard(
                Paths.get(generatedDirectory.getAbsolutePath(), "tc09h", TC_GROUP_NAME).toFile()
        ));


        generatorSet.add(new Tc10GeneratorSyntheticConstructedHard(
        ...
        generatorSet.add(new Tc12GeneratorSyntheticConstructedHard(
                Paths.get(generatedDirectory.getAbsolutePath(), "tc12h", TC_GROUP_NAME).toFile()
        ));
